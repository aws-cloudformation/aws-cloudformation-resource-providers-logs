...
public class ListHandlerTest {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxy.injectCredentialsAndInvokeV2(any(ListLogAnomalyDetectorsRequest.class), any()))
                .thenReturn(ListLogAnomalyDetectorsResponse.builder()
                        .anomalyDetectors(Collections.singletonList(AnomalyDetector.builder()
                                .anomalyDetectorArn("arn:aws:logs:us-east-1:123456789012:anomaly-detector/12345678901234567890123456789012")
                                .build()))
                        .build());

...
public class TranslatorTest {
    ...
    private static final software.amazon.awssdk.services.cloudwatchlogs.model.MetricTransformation METRIC_TRANSFORMATION = software.amazon.awssdk.services.cloudwatchlogs.model.MetricTransformation
        .builder()
        .defaultValue(1.0)
    ...
    private static final MetricTransformation RPDK_METRIC_TRANSFORMATION = MetricTransformation
        .builder()
        .defaultValue(1.0)
        .metricName("MetricName")
        .metricNamespace("MyNamespace")
    ...
    private static final MetricFilter METRIC_FILTER = MetricFilter
        .builder()
        .filterName("Filter")
    ...
    public void translate_nullSDKModel_returnsNull() {
        assertThat(
            Translator.translateMetricTransformationFromSdk(
                (software.amazon.awssdk.services.cloudwatchlogs.model.MetricTransformation) null
            )
        )
            .isNull();
    }
    ...
    public void extractMetricFilters_success() {
        final DescribeMetricFiltersResponse response = DescribeMetricFiltersResponse
            .builder()
            .metricFilters(Collections.singletonList(METRIC_FILTER))
            .build();

        final List<ResourceModel> expectedModels = Arrays.asList(
            ResourceModel
                .builder()
                .filterName("Filter")
                .logGroupName("LogGroup")
    ...
    public void translateToDeleteRequest() {
        final DeleteMetricFilterRequest expectedRequest = DeleteMetricFilterRequest
            .builder()
            .filterName("FilterName")
            .logGroupName("LogGroup")
            .build();
    ...
    public void translateToPutRequest() {
        final PutMetricFilterRequest expectedRequest = PutMetricFilterRequest
            .builder()
            .logGroupName("LogGroup")
            .metricTransformations(Collections.singletonList(METRIC_TRANSFORMATION))
            .filterPattern("Pattern")
    ...
    public void translateToReadRequest() {
        final DescribeMetricFiltersRequest expectedRequest = DescribeMetricFiltersRequest
            .builder()
            .logGroupName("LogGroup")
    ...
    public void translateToListRequest() {
        final DescribeMetricFiltersRequest expectedRequest = DescribeMetricFiltersRequest.builder().limit(50).nextToken("token").build();

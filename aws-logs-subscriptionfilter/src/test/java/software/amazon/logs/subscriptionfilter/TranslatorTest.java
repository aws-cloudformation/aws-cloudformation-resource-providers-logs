...
class TranslatorTest {
    ...
    private static final SubscriptionFilter SUBSCRIPTION_FILTER = SubscriptionFilter
        .builder()
    ...
    void extractSubscriptionFilters_success() {
        final DescribeSubscriptionFiltersResponse response = DescribeSubscriptionFiltersResponse
            .builder()
            .subscriptionFilters(Collections.singletonList(SUBSCRIPTION_FILTER))
            .build();

        final List<ResourceModel> expectedModels = Collections.singletonList(
            ResourceModel
                .builder()
                .filterName("FilterName")
                .logGroupName("LogGroup")
    ...
    void extractSubscriptionFilters_API_removesEmptyFilterPattern() {
        final DescribeSubscriptionFiltersResponse response = DescribeSubscriptionFiltersResponse
            .builder()
            .subscriptionFilters(Collections.singletonList(SUBSCRIPTION_FILTER.toBuilder().filterPattern(null).build()))
            .build();
    ...
    void translateToDeleteRequest() {
        final DeleteSubscriptionFilterRequest expectedRequest = DeleteSubscriptionFilterRequest
            .builder()
            .filterName("FilterName")
            .logGroupName("LogGroup")
            .build();
    ...
    void translateToPutRequest() {
        final PutSubscriptionFilterRequest expectedRequest = PutSubscriptionFilterRequest
            .builder()
            .filterName("FilterName")
            .logGroupName("LogGroup")
            .destinationArn("DestinationArn")
    ...
    void translateToReadRequest() {
        final DescribeSubscriptionFiltersRequest expectedRequest = DescribeSubscriptionFiltersRequest
            .builder()
            .logGroupName("LogGroup")

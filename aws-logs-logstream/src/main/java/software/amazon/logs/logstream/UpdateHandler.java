...
////                proxy.initiate("AWS-Logs-LogStream::Update::PreUpdateCheck", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
////
...
////                proxy.initiate("AWS-Logs-LogStream::Update::first", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
////
...
////                    proxy.initiate("AWS-Logs-LogStream::Update::second", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
////

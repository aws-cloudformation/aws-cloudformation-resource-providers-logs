    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-Logs-LogStream::Delete::PreDeletionCheck", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-Logs-LogStream::Delete", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
